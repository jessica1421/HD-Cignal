...
create table "CONTACTINFOS" ("NAME" VARCHAR NOT NULL,"ID_COMPANY" INTEGER NOT NULL,"ID" SERIAL NOT NULL PRIMARY KEY);
...
create table "POSTING_METHODS" ("CODE" SERIAL NOT NULL PRIMARY KEY);
